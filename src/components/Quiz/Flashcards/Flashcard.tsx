  ...
  return (
    <>
      ...
      >
        ...
        >
          <div className="bg-secondary dark:bg-secondaryDark flex items-center justify-center rounded-sm p-4 absolute w-full h-full [backface-visibility:hidden]">
          ...
          <div className="bg-secondary dark:bg-secondaryDark flex items-center justify-center rounded-sm p-4 w-full h-full overflow-auto [backface-visibility:hidden] [transform:rotateX(180deg)]">
            <p className="text-xl sm:text-2xl xl:text-3xl">
              {questions.length > 0
