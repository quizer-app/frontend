...
export default function QuizTile({ title, author }: QuizTileProps) {
  return (
    <div className="bg-secondary rounded-md max-w-sm md:max-w-xs lg:max-w-sm xl:max-w-[350px] 2xl:max-w-sm">
      ...
      <div className="p-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="border-r-[1px] border-white border-opacity-10 pr-4">
            <h4 className="text-white font-semibold text-sm">By {author}</h4>
