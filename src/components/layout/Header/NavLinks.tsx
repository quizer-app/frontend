...
export default function NavLinks({ isOpen, onClick }: NavLinksProps) {
  ...
  return (
    <div>
      <ul
        className={`${isOpen ? "flex" : "hidden"} flex-col bg-secondary dark:bg-secondaryDark
          ...
          sm:gap-4 sm:top-[5.5rem] lg:bg-transparent dark:lg:bg-transparent lg:flex-row lg:static
